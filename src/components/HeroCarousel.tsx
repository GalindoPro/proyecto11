...
export function HeroCarousel() {
    ...
    return (
        <div className="relative h-[85vh] w-full overflow-hidden bg-gray-900" id="inicio">
            {/* Slides Background */}
            ...
            {/* Content Container */}
            <div className="absolute bottom-32 left-0 right-0 z-10 flex flex-col items-center pointer-events-none">
                {/* CTA Button */}
                <motion.div
                    key={`btn-${current}`}
                ...
                >
                    <Link
                        ...
                        className={cn(
                            "group relative inline-flex items-center gap-3 backdrop-blur-sm border-2 px-10 py-5 rounded-full text-2xl font-bold transition-all duration-300 shadow-2xl hover:-translate-y-1 overflow-hidden",
                    ...
                    >
                        ...
                        <ChevronRight className="w-8 h-8 relative z-10 group-hover:translate-x-1 transition-transform" />
                    </Link>
                </motion.div>
            </div>
